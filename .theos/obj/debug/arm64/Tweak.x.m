...
@class _CDBatterySaver; @class NSProcessInfo; @class IMServiceSession; @class SBHardwareButtonInteraction; @class SBAccessibilityHardwareButtonInteraction; @class SBHomeHardwareButtonActions; 
